...
public class insert {
...

	{
		...
		try {
			...
			int result=statement.executeUpdate("insert into Employee(eid,ename,salary,department) values(6,'Bharat',2300000,'PR')");
            System.out.println(result+" row(s) inserted succesfully");
